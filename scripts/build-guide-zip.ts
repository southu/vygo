...
function main(): void {
  ...
  const manifestLines = [
    ...
    "",
    "This archive is architecture and how-to documentation only. It contains no",
    "API keys, no vault passwords, and no host credentials. Paths in the guide",
    "(for example RATCHET_ROOT/{control,harness,projects}) are illustrative",
    "placeholders — rename them to match your own install. This pack is not",
    "access to anyone's running VPC, and it is not a host operations runbook.",
    "",
