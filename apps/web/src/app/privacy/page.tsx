 ...
 * Do not present as operative privacy policy until counsel approves.
 */
import type { Metadata } from "next";
import { site } from "@/content/site";
import { legalMeta, privacyContent } from "@/content/legal";

export const metadata: Metadata = {
  title: site.metadata.privacyTitle,
  description: "Draft privacy notice for the vygo.ai marketing website and waitlist application.",
};
    ...
    >
      <section className="section-pad">
        <div className="container-page max-w-prose">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold">{privacyContent.title}</h1>
          <p
