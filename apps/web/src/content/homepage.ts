...
export const homepage = {
  hero: {
    ...
    supporting: commercialFlags.showUsBasedClaim
      ? "You already proved people want the product. vygo, operated by VYGO LLC, preserves the UX and workflows your users validated, then re-engineers the foundation for security, scale, compliance readiness, and sustained operations. Fixed-price work after audit, senior U.S.-based delivery, and full IP handoff under a separately executed agreement with VYGO LLC—without erasing what already works. Services begin only under that agreement; submitting an inquiry does not form a client relationship. Questions, privacy requests, or legal notices may be sent to hello@vygo.ai. Notices are effective when received."
      : "You already proved people want the product. vygo, operated by VYGO LLC, preserves the UX and workflows your users validated, then re-engineers the foundation for security, scale, compliance readiness, and sustained operations. Fixed-price work after audit and full IP handoff under a separately executed agreement with VYGO LLC—without erasing what already works. Services begin only under that agreement; submitting an inquiry does not form a client relationship. Questions, privacy requests, or legal notices may be sent to hello@vygo.ai. Notices are effective when received.",
