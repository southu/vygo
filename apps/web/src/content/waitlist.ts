...
export const waitlistContent = {
  ...
  success: {
    ...
    body: "VYGO LLC will review your application against the next available Production Readiness Audit and engineering opening. Submitting does not form a client relationship. Services begin only under a separately executed agreement with VYGO LLC. If a customer contract or security review has a hard deadline, or for questions, privacy requests, or legal notices, contact hello@vygo.ai. Notices are effective when received.",
