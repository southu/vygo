...
export const auditContent = {
  hero: {
    ...
    body: "Before you commit to a rebuild, senior engineers inspect the code, data model, access controls, infrastructure, deployment process, and operational risks. You leave with a prioritized report and a fixed-price path forward.",
