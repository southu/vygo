...
export const securityContent = {
  ...
  complianceNote:
    "Certification and attestation decisions are made by independent auditors or certification bodies. vygo, operated by VYGO LLC, prepares the product and operating program for compliance readiness; readiness work does not guarantee certification or attestation.",
  language: {
    use: [
      "SOC 2 readiness",
      "ISO 27001 pathway",
