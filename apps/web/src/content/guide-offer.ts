...
export const guideOffer = {
  ...
  intro:
    "The complete Ratchet system guide, v1.2, as one free zip: overview, architecture, the loop contract, Composer, Vault, operations, and the phase A–E rebuild checklist.",
  assurances: [
