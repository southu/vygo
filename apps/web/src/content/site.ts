...
export const site = {
  ...
  metadata: {
    ...
    methodDescription:
      "The vygo production rebuild method, operated by VYGO LLC: a fixed six-step path from Production Readiness Audit through rebuild, hardening, compliance readiness, and operations. Services begin only under a separately executed agreement with VYGO LLC.",
    securityTitle: "Security and Compliance Readiness for AI-Built Software",
    securityDescription:
      "Security controls, identity, data protection, offensive testing, and compliance readiness built into production engineering by vygo, operated by VYGO LLC. Client services begin only under a separately executed agreement with VYGO LLC.",
    pricingTitle: "Engagement Pricing",
    pricingDescription:
      "Fixed-price Production Readiness Audit, Launch, Scale, and Enterprise rebuild engagements from vygo, operated by VYGO LLC, plus ongoing Ops plans. Services begin only under a separately executed agreement with VYGO LLC.",
